...
public class ServerGUI extends JFrame implements BoardPanel.BoardPanelListener {
    ...
    protected static final String[] PLAYER_CLASSES = { "pentago_swap.RandomPentagoPlayer", "student_player.StudentPlayer","dibbo_student_player.StudentPlayer","adeeb_student_player.StudentPlayer","justin_student_player.StudentPlayer","adrien_student_player.StudentPlayer","greedy.StudentPlayer" };
